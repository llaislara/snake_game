...
class Snake {
  ...
  drawCell(x, y) {
    ...
    CTX.lineTo(x + this.size - this.cornerRadius, y);
    CTX.quadraticCurveTo(x + this.size, y, x + this.size, y + this.cornerRadius);
    CTX.lineTo(x + this.size, y + this.size - this.cornerRadius);
    CTX.quadraticCurveTo(
      x + this.size,
      y + this.size,
      x + this.size - this.cornerRadius,
      y + this.size
    );
    CTX.lineTo(x + this.cornerRadius, y + this.size);
    CTX.quadraticCurveTo(x, y + this.size, x, y + this.size - this.cornerRadius);
